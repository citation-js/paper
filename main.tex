...
The number of mapped RIS properties is actually too high; the RIS mapping has a lot of one-to-many and many-to-one mappings, which makes it inconsistent and unreliable, while artificially raising the number of mapped properties. Since there is no authoritative document other than Wikipedia, the mapping is based on the Zotero translator for RIS.
